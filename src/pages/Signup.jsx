...
import { ShoppingBag, CheckCircle, AtSign, Info } from 'lucide-react'
    ...
    if (success) return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl border border-gray-200 p-8 max-w-md w-full text-center animate-scale-in">
                ...
                <p className="text-xs text-gray-400 mb-6">Click it to activate your account, then sign in.</p>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-card p-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            {/* Hidden email field — submitted with the form */}
